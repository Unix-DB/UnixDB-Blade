                        ...
                        <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                                    ...
                                                    <div class="ml-4 md:flex-1 md:flex md:flex-col md:justify-between lg:ml-0 lg:mt-4">
                                                        <div>
                                                            <p class="text-base font-medium text-gray-900">Latest</p>
                                                            <p class="mt-1 text-sm text-gray-500">View all the lates posts on Unix DB.</p>
                                                        </div>
                                                        <p class="mt-2 text-sm font-medium text-indigo-600 lg:mt-4">Latest Posts <span aria-hidden="true">&rarr;</span></p>
                                                    </div>
                                                </div>
                                            </a>
